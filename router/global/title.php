...
<? if(R("mobile")){ ?>
  ...
  <div class="Root">
    <div class="NavDots BO RA YH">
      ...
      <a class="NavDot NavDotMargin NavDot2<?=$NAVIDX>=2?" active":""?>" href="javascript:void(0);" onclick="GoPage(2);">选择测<br>算方式</a>
      <a class="NavDot NavDotMargin NavDot3<?=$NAVIDX>=3?" active":""?>" href="javascript:void(0);" onclick="GoPageInput();">输入<br>数据</a>
      <a class="NavDot NavDotMargin NavDot4<?=$NAVIDX>=4?" active":""?>" href="javascript:void(0);" onclick="GoPageResult();">测算<br>结果</a>
      <a class="NavDot NavDot5<?=$NAVIDX>=5?" active":""?>" href="javascript:void(0);" onclick="GoPageSaved();">保存<br>列表</a>
      <div class="C"></div>
      ...
      <div class="NavSep NavSep5<?=$NAVIDX>=5?" active":""?>" style="right:61px;"></div>
    </div>
  </div>
  <script type="text/javascript">
  window.resizings.push(function(){
    var w=$(".NavDots").innerWidth();
    $(".NavDots .NavDotMargin").css("margin-left",(w>300?Math.floor((w-300)/4):0)+"px");
    $(".NavDots .NavSep").toggle(w>300);
    if(w>300){
      var n=(w-300)/4;
      $(".NavDots .NavSep").css("width",n+"px");
      $(".NavDots .NavSep3").css("left",(120+n)+"px");
      $(".NavDots .NavSep4").css("right",(120+n+1)+"px");
    }
  });
  </script>
  <div class="BR" style="height:15px;"></div>
<? }else{ ?>
  ...
  <div class="Root">
    <div class="NavDots BO RA YH">
      <a class="NavDot NavDot1<?=$NAVIDX>=1?" active":""?>" href="<?=U("~/choose/")?>">选择物<br>业类型</a>
      <a class="NavDot NavDot2<?=$NAVIDX>=2?" active":""?>" href="javascript:void(0);" onclick="GoPage(2);">选择测<br>算方式</a>
      <a class="NavDot NavDot3<?=$NAVIDX>=3?" active":""?>" href="javascript:void(0);" onclick="GoPageInput();">输入<br>数据</a>
      <a class="NavDot NavDot4<?=$NAVIDX>=4?" active":""?>" href="javascript:void(0);" onclick="GoPageResult();">测算<br>结果</a>
      <a class="NavDot NavDot5<?=$NAVIDX>=5?" active":""?>" href="javascript:void(0);" onclick="GoPageSaved();">保存<br>列表</a>
      <div class="NavSep NavSep2<?=$NAVIDX>=2?" active":""?>"></div>
      <div class="NavSep NavSep3<?=$NAVIDX>=3?" active":""?>"></div>
      <div class="NavSep NavSep4<?=$NAVIDX>=4?" active":""?>"></div>
      <div class="NavSep NavSep5<?=$NAVIDX>=5?" active":""?>"></div>
    </div>
  </div>
  <div class="BR" style="height:60px;"></div>
<? } ?>
...
function GoHint(){BirdFrame("#CesuanTishiBtn","<?=U("~/hint/")?>",{},{},false,"测算提示","<?=R("mobile")?"300":"500"?>px","<?=R("mobile")?"66%":"600px"?>");}
function GoPage(page){
  ...
  if(page==5){SavedPageWait();BirdPost(this,'.SavedListPost','list','#SavedTableFrame');}
}
</script>